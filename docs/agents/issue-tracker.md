...
- Each child ticket is `.scratch/<effort>/issues/<NN>-<slug>.md`, with a `Type:` line of `research`, `prototype`, `grilling`, or `task`, and a `Status:` line of `open`, `claimed`, or `resolved`.
